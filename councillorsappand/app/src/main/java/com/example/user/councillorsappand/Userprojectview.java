...
public class Userprojectview extends AppCompatActivity {
    ListView li;
    String[] name,details,Photo,pid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_userprojectview );
        li=(ListView)findViewById( R.id.list4 );
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5000/and_userprojectview";
...
//                                gv.setAdapter(new Custom_view_visited_game(getApplicationContext(),name,gamecode));
                                li.setAdapter(new custom_userprojectview(getApplicationContext(),name,details,Photo,pid));//custom_view_service.xml and li is the listview object
                            }
