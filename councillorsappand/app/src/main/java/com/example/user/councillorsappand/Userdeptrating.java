...
public class Userdeptrating extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    RatingBar r1;
    Button b1;
    Spinner select;
    String[] did,cname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_userdeptrating );
        ...
        select.setOnItemSelectedListener( this );
            ...
            String url = "http://" + hu + ":5000/and_dept";
...
//                                rating=new String[js1.length()];
                                    ...
                                    for (int i = 0; i < js.length(); i++) {
                                        ...
                                        did[i] = u.getString( "dept_id" );//dbcolumn name
...
//                params.put("mac",maclis);
    ...
    public void onClick(View view) {
        ...
        String hu = sh.getString( "ip", "" );
        String url = "http://" + hu + ":5000/and_insertdeptrating";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString( "status" ).equalsIgnoreCase( "Inserted" )) {
                                ...
                                startActivity( new Intent( getApplicationContext(), Userdeptrating.class ) );
