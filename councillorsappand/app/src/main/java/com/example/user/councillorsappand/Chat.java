...
public class Chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toid=Chatwithcouncillor.councillorid[Chatwithcouncillor.pos];
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString( "status" ).equalsIgnoreCase( "ok" )) {
                                        ...
                                        for (int i = 0; i < jss.length(); i++) {
                                            ...
                                            message.setMessage( js.getString( "messege" ) );//dbcolumnname
...
//                         Toast.makeText(Chat.this, ""+js.getString("from_id"), Toast.LENGTH_SHORT).show();
                                            message.setDate( dt );
                                            if (js.getString( "from_id" ).equalsIgnoreCase( sh.getString( "logid", "" ) )) {
                                                message.setUsername( "Me" );//text
//                                                Toast.makeText( Chat.this, "kkkkk", Toast.LENGTH_SHORT ).show();
                                                message.setIncomingMessage( false );
                                            } else {
                                                message.setUsername( Chatwithcouncillor.pname[Chatwithcouncillor.pos] );
    ...
    public void onBackPressed() {
        ...
        startActivity( new Intent( Chat.this,Chatwithcouncillor.class ) );
    }
}