...
public class custom_coordinatorpolicyview extends BaseAdapter{
    String[] pname1,councillorname1,des1,date1,photo1;
    private Context context;

    public custom_coordinatorpolicyview(Context applicationContext, String[] pname, String[] councillorname, String[] des, String[] photo, String[] date) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_coordinatorpolicyview,null);//same class name
