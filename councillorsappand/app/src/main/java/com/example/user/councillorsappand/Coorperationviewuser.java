...
public class Coorperationviewuser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_coorperationviewuser );
        t1=(TextView)findViewById(R.id.textView38);
        t2=(TextView)findViewById(R.id.cplace);
//        t3=(TextView)findViewById(R.id.cpost);
        ...
        String url = "http://" + hu + ":5000/and_coorperationprofile";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                t2.setText(place);
//                                String post=jj.getString("post");
//                                t3.setText(post);
                                String pin=jj.getString("pin");
                                t4.setText(pin);
